package com.github.cao.awa.lilium.debug.dependency.circular;

import com.github.cao.awa.apricot.util.collection.ApricotCollectionFactor;
import com.github.cao.awa.lilium.exception.auto.CircularDependencyException;
...
public class CircularDependency {
    ...
    public void pushRequirement(Object target, RequiredDependency dependency) {
        ...
        this.dependencies.put(target, dependency);
    ...
    public void checkCircular(Object target, Stack<Object> o, boolean inner) {
        ...
        this.dependencies.get(target).forEach(required -> {
            o.push(required);
            ...
            for (Object object : o) {
                ...
                if (map.get(object) == 2) {
                    o.pop();
                    throw new CircularDependencyException(o.stream().map(Object::toString).toList(), object.toString());
                }
            }
            checkCircular(required, o, true);
            if (inner) {
                o.pop();
            }
        });
